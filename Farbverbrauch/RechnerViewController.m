...
- (void)generateData
{
    dispatch_async( dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        NSData *RechnerURL = [[NSData alloc] initWithContentsOfURL:[NSURL URLWithString:@"http://farbverbrauch.myself5.de/_h5ai_json/farbverbrauch.json"]];
        ...
        dispatch_async( dispatch_get_main_queue(), ^{
            ...
            [contents enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
                [data addObject:[NSDictionary dictionaryWithObjectsAndKeys:[obj objectForKey:@"Gewebe"], @"DisplayText",obj,@"CustomObject", nil]];
            }];
        });
    });
}
